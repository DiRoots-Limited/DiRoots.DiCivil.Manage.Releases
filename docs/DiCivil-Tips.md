...
![Reset Functionality](../assets/images/Tips/Reset-Functionality.gif)
<sub>Note: the version on the image may not reflect the [latest version of DiCivil Package](https://diroots.com/Civil3D-plugins/DiCivil/).</sub>
...
![Right-click on the row - Context menu](../assets/images/Tips/Right-click-on-the-row-Context-menu.gif)
<sub>Note: the version on the image may not reflect the [latest version of DiCivil Package](https://diroots.com/civil3D-plugins/DiCivil/).</sub>
